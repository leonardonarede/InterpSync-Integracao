...
/*  80: 79 */       Logger.getLogger(Integracao.class.getName()).log(Level.SEVERE, null, ex);
                     StackTraceElement st[] = ex.getStackTrace();
                      ...
                      new Geralog().enviar("Integrador", erro);
/*  81:    */     }
...
/*  84: 81 */       Logger.getLogger(Integracao.class.getName()).log(Level.SEVERE, null, ex);
                     StackTraceElement st[] = ex.getStackTrace();
                      ...
                      new Geralog().enviar("Integrador", erro2);
/*  85:    */     }
...
/*  88: 83 */       Logger.getLogger(Integracao.class.getName()).log(Level.SEVERE, null, ex);
                     StackTraceElement st[] = ex.getStackTrace();
                      ...
                      new Geralog().enviar("Integrador", erro3);
/*  89:    */     }
...
/* 314:    */         {
/* 315:255 */           if (osvrINTERDBDAO.localizarPorID(osvr.getNrOS(), osvr.getTipoReg(), osvr.getCodigoReg(),osvr.getOSVRID()).getNrOS() == null)
/* 316:    */           {
...
/* 366:    */     {
                    Logger.getLogger(Integracao.class.getName()).log(Level.SEVERE, null, ex);
                     StackTraceElement st[] = ex.getStackTrace();
                      String erro = "";
                      for (int i = 0;i < st.length;i++){
                          erro += st[i].toString() + "\n";
