...
/* 46:   */   {
/* 47:48 */     String sql = "SELECT prd.no AS Produto FROM sqldados.prd WHERE free_fld1 = ?    AND prd.groupno IN (020000,030000)";
/* 48:   */     
...
/* 69:   */   {
/* 70:70 */     String sql = "SELECT prd.no AS Produto FROM sqldados.prd WHERE (free_fld1 = ? OR free_fld2 = ?)    AND (prd.name LIKE 'CARCACA%') ";
/* 71:   */     
