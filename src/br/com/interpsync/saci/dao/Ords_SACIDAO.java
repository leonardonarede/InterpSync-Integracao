...
/* 47:   */   {
/* 48:49 */     String sql = "INSERT INTO sqldados.ords (no,date,vendno,storeno,empno,remarks,status,ordnoFromVend,    discountOrig, l1, l2, l3, l4, m1, m2, m3, m4, bits3, s1, s2, s3, s4, c1, c2, c3, c4, dataFaturamento, auxShort2)    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
/* 49:   */     
/* 50:   */ 
...
/* 86:   */   {
/* 87:89 */     String sql = "SELECT MAX(ords.no) AS ult FROM sqldados.ords WHERE ords.storeno = 4 ";
