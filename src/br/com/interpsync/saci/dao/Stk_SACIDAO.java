...
/* 47:   */   {
/* 48:49 */     String sql = "SELECT storeno, prdno, qtty_varejo, lastchangedt FROM sqldados.stk    WHERE storeno = 4 and prdno = ?";
/* 49:   */     
...
/* 75:   */   {
/* 76:75 */     String sql = "UPDATE sqldados.stk SET qtty_varejo = ?, lastchangedt = ?    WHERE storeno = ? AND prdno = ?";
/* 77:   */     
