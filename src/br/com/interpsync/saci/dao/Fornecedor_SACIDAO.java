...
/*  47:    */   {
/*  48: 48 */     String sql = "INSERT INTO sqldados.vend    (no, name, sname, cgc, insc,  nei, city, state, auxChar1, zip, ext, coll, fabOufor,     l1, l2, l3, l4, l5, l6, l7, l8, m1, m2, m3, m4, m5, m6, m7, m8, auxShort4, s1, s2, s3,     s4, s5, s6, s7, s8, addr, c1, wshash) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,  ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
/*  49:    */     
/*  50:    */ 
/*  51:    */ 
/*  52:    */ 
...
/* 101:    */   {
/* 102:102 */     String sql = "SELECT no, name, sname, cgc, insc, nei, city, state, auxChar1, zip, ext, coll, fabOufor   FROM   sqldados.vend WHERE cgc = ? ";
/* 103:    */     
...
/* 130:    */   {
/* 131:130 */     String sql = "SELECT MAX(vend.no) AS ultimo FROM sqldados.vend";
