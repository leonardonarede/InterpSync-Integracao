...
/*  49:    */   {
/*  50: 51 */     String sql = "SELECT custp.cpf_cgc  , custp.name , custp.add1 , custp.nei1 , custp.city1 , custp.state1 , custp.zip , fjflag , salesperson , brthplace_insc , IFNULL(custp.crlimit,0)/100 crlimit FROM   sqldados.custp  WHERE  (custp.no <> '100001') AND    (custp.nei1 <> '')  AND    (MID(custp.zip,1,9) > 0)  AND    (custp.sincedt = DATE_FORMAT(CURDATE(),'%Y%m%d')) GROUP BY 1 ORDER BY 1 DESC";
/*  51:    */     
/*  52:    */ 
/*  53:    */ 
/*  54:    */ 
...
/*  94:    */   {
/*  95: 96 */     String sql = "SELECT * FROM sqldados.custp WHERE cpf_cgc = ? ";
